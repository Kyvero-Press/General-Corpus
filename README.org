...
See the [[file:docs/corpus-viewer.md][corpus viewer guide]] for development, testing, catalog generation, and deployment commands.

* Change-aware validation
Before pushing manifest or viewer work, run the change-aware gate from the
repository root:
...
- [[file:docs/corpus-viewer.md][Corpus web viewer]]
- [[file:manifests/publication-set/README.md][Viewer publication-set snapshot]]
- [[file:docs/lineage-manifests.md][Source lineage, access, and rights manifests]]
- [[file:docs/work-metadata-manifests.md][Descriptive work metadata manifests]]
